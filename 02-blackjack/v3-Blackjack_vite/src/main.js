...
//   const showedPlayerCards   = document.querySelector('#player-cards');
//   const showedComputerCards = document.querySelector('#computer-cards');

//   const showedScores = document.querySelectorAll('small');
  ...
  const startGame = (totalPlayers = 2 ) => {
    ...
    //   playerPoints     = 0;
    //   computerPoints = 0;
    //   showedComputerCards.innerHTML = '';
    //   showedPlayerCards.innerHTML = '';
